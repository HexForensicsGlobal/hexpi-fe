  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="relative">
        <div className="bg-card/80 backdrop-blur-xl rounded-3xl p-6 border border-border/50 shadow-2xl">
          ...
          <div className="mt-3 flex items-center gap-2">
            <div className="flex items-center gap-1 px-3 py-1 bg-muted/30 rounded-full text-xs text-foreground">
              <div className="w-4 h-4 rounded-sm bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500" />
